      ...
      <div className="blur">
         <div className="postBox selectCoverBox" ref={Ref}>
            ...
            <div className="selectCoverBox_links"> 
               <div className="selectCoverBox_link">Fotos recientes</div>
               <div className="selectCoverBox_link">Album de fotos</div>
            </div>
            <div className='old_pictures_wrap scrollbar'>
               ...
               <div className='old_pictures'>
                  { photos && photos.filter((img)=> img.folder === `${user.username}/post_images`).map((photo)=>(
                     <img 
                        src={photo.secure_url} 
                        key={photo.public_id} 
                        alt="" 
